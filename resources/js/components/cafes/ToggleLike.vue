...
<template>
    <span class="toggle-like">
        <span class="like" v-on:click="likeCafe( cafe.id )"
              v-if="!liked && cafeLoadStatus === 2 && cafeLikeActionStatus !== 1 ">
            喜欢
        </span>
        ...
        <loader v-show="cafeLikeActionStatus === 1"
                :width="30"
                :height="30"
                :display="'inline-block'">
        </loader>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            liked() {
                return this.$store.getters.getCafeLike;
            },
        ...
        methods: {
            ...
            unlikeCafe(cafeID) {
                this.$store.dispatch('dislikeCafe', {
                    id: this.cafe.id
                });
            }
        }
